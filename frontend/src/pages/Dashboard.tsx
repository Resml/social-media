      ...
      <div className="max-w-7xl mx-auto md:p-4">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div>
              ...
              <p className="text-slate-500 text-sm">
                Track your performance and manage your content library.
              </p>
            </div>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4 px-1">
             <h2 className="text-lg font-bold" style={{ color: 'var(--slate-800)' }}>Performance</h2>
             <span className="text-xs text-slate-500 font-medium">Last 7 days</span>
          </div>

          {summary && (
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
              <StatCard label="Post Reach"  value={summary.postImpressions.toLocaleString()} delta={summary.impressionsDelta} deltaSuffix="%" icon={Eye} />
              <StatCard label="New Mentions" value={summary.newMentions} delta={summary.mentionsDelta} icon={AtSign} />
              <StatCard label="Net Followers" value={summary.totalFollowers.toLocaleString()} delta={summary.followerDelta}    deltaSuffix="%" icon={Users} />
        ...
        <div className="mb-8 rounded-2xl p-5 border" style={{ background: '#fff', borderColor: 'var(--slate-200)' }}>
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-bold px-2.5 py-1 rounded-full" style={{ background: 'var(--brand-50)', color: 'var(--brand-700)' }}>From your strategy doc</span>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              { label: 'Personal Posts',  pct: 50, icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>, shade: 'var(--brand-800)', bg: 'var(--brand-100)', tip: 'Gets highest likes, shares & comments' },
              { label: 'Motivational',    pct: 25, icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>, shade: 'var(--brand-700)', bg: 'var(--brand-50)', tip: 'Inspiration and leadership content' },
              { label: 'Educational',    pct: 17, icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>, shade: 'var(--brand-600)', bg: 'var(--brand-50)', tip: 'Informative, awareness content' },
              { label: 'Entertainment',  pct: 17, icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="5 3 19 12 5 21 5 3"/></svg>, shade: 'var(--slate-600)', bg: 'var(--slate-100)', tip: 'Cultural, fun, engaging content' },
            ].map(item => (
        ...
        <div className="mt-8 rounded-2xl p-6" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #0c3b6e 100%)', border: '1px solid #1e293b' }}>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-bold text-white" style={{ fontFamily: 'Outfit,sans-serif', fontSize: '1rem' }}>Algorithm Tips — From Your Strategy Document</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3">
            {[
              { svgPath: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', tip: 'Post 2–3 times daily', detail: 'Stay consistent — daily activity boosts reach significantly.' },
              { svgPath: 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z', tip: 'Use images in every post', detail: 'Image posts get 2× more engagement than text-only posts.' },
              { svgPath: 'M7 20l4-16m2 16 4-16M6 9h14M4 15h14', tip: '2–3 hashtags only', detail: 'Using too many hashtags reduces reach. Stick to 2–3 relevant ones.' },
              { svgPath: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15', tip: 'Repost after 15 days', detail: 'Facebook shows posts to only 5–7% of followers. Repost important content.' },
              { svgPath: 'M15 10l4.553-2.069A1 1 0 0121 8.87V15.13a1 1 0 01-1.447.9L15 14M3 8a2 2 0 012-2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z', tip: 'Go Live as often as possible', detail: 'Live videos get higher priority in the algorithm and build trust.' },
              { svgPath: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z', tip: 'Comment on others\' posts', detail: 'Engaging with others increases your own post visibility in the feed.' },
            ].map((item, i) => (
