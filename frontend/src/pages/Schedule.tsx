              ...
              <div className="flex items-center gap-5">
                ...
                <div className="w-14 h-14 rounded-xl flex flex-col items-center justify-center font-bold shrink-0"
                  ...
                  <span className="text-[10px] uppercase font-bold">
                    {new Date(p.scheduledAt).toLocaleDateString(i18n.language.startsWith('hi') ? 'hi-IN' : i18n.language.startsWith('mr') ? 'mr-IN' : i18n.language.startsWith('hi') ? 'hi-IN' : 'en-US', { month: 'short' })}
                  </span>
                ...
                <div>
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest" style={{ color: 'var(--slate-400)' }}>
                    {new Date(p.scheduledAt).toLocaleTimeString(i18n.language.startsWith('hi') ? 'hi-IN' : i18n.language.startsWith('mr') ? 'mr-IN' : i18n.language.startsWith('hi') ? 'hi-IN' : 'en-US')}
                  </p>
                </div>
              </div>
